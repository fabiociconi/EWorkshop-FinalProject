...
{
    public class PeopleAddressesQuery: SpecificationQuery<PeopleAddresses, PeopleAddressesFilter>
    {
        public override IQueryable<PeopleAddresses> Build(IQueryable<PeopleAddresses> source, PeopleAddressesFilter filter)
        {
