...
{
    public class PeopleAddressesValidate: SpecificationValidation<PeopleAddressesEntity>
    {
        public override bool IsSatisfiedBy(PeopleAddressesEntity entity, Execute execute)
        {
