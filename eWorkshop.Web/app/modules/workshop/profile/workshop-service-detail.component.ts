...
@Component({
    selector: "workshop-service-detail",
    templateUrl: "./workshop-service-detail.html",
    styleUrls: ["./workshop-service-detail.scss"]
})
export class WorkshopServiceDetailComponent implements OnInit {
